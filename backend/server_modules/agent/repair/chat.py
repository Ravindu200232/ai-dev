# Chat-driven bug fixes for an existing project in the repair domain.
def bind_host() -> str:
...
def run_chat(proj_name: str, text: str, model: str, route: str = "",
             think: bool = False, qa_model: str = "", console: str = ""):
...
def _reproduce_complaint(proj_dir: Path, route: str, complaint: str, analyzer):
    ...
    from agents.testing.reproduce import Reproduction, reproduce
...
def run_bug_report(proj_name: str, complaint: str, model: str, route: str = "",
    ...
    try:
        ...
        elog("INFO", f"🔧 Bug Fixer — Builder {model} · thinking "
