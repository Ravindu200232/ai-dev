# Picture generation, uploads, and image completion.
...
def _think_flag(msg: dict) -> bool:
    """The opt-in Builder/QA thinking switch; missing always means off."""
    return bool(msg.get("think", False))
